...
@type console.js vendor\zepto.min.js zepto.eof.txt vendor\ejohn-class.js bin\atomos-bin.js hx\atomos-hx.js dev\atomos-dev.js system.js libsys.js > atomos.t.js 2>NUL
